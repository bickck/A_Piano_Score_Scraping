...
#### ◎ DB에 저장된 데이터를 효율적으로 탐색하는 작업이 필요
...
### ----------------------  다음 프로젝트를 위해 필요한 기술  ----------------------
#### Junit <= TDD를 위해 처음 써보는 메서드도 테스트를 해야하고 만든 코드도 테스트를 해야하는데 가끔씩 어디에 코드를 만들었는지 헷갈리고 오래걸림 만약에 배운다면 더 빨리 테스트를 진행할 수 있지 않을까


### --------------------------  진행중 어려웠던 점  --------------------------------
#### 1. 혼자 개발하다보니 필요한 코드와 리펙토링 작업이 많음
#### 2. 공부를 하면서 만들어야 하므로 속도가 느림
#### 3. 이전에 만들었던 코드를 이해하기 위해 효율적인 이름 설계의 어려움
